...
// The full definition is provided by the corresponding ui_*.h file, which is included only in the implementation (.cpp) to keep this header lightweight and reduce compilation dependencies.
namespace Ui {
...
private:
	...
	std::unique_ptr<Ui::SEPathlineOfCenterOfMassVisualModelPropertiesClass>		ui;
